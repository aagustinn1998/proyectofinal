...
// let serviceAccount = require("./ecommerce-coder-98-firebase-adminsdk-cjay7-f10cd5339e");
...
// declare static path
let staticPath = path.join(__dirname, "entrega-final");
...
app.post('../signup.html', (req, res) => {npm 
...
//         return res.json({'alert': 'Ingresa tu email'});
//     } else if(password.length < 8){
//         return res.json({'alert': 'La contraseña debe tener mas de 8 letras '});
//     } else if(!number.length){
//         return res.json({'alert': 'Introduce tu numero de celular'});
//     } else if(!Number(number) || number.length < 10){
//         return res.json({'alert': 'Numero invalido'});
//     } else if(!tac){
//         return res.json({'alert': 'Acepta nuestras terminos y condiciones '});
//     } 
